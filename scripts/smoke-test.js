...
try {
  ...
  assert(appSource.includes("renderThreeOfficeView"), "browser app should render Office view through the Three.js scene module");
  ...
  const officeSceneSource = await readFile(new URL("../src/officeScene.js", import.meta.url), "utf8");
  assert(officeSceneSource.includes('import * as THREE from "./vendor/three.module.js"'), "Office view should use vendored Three.js");
  assert(officeSceneSource.includes("new THREE.WebGLRenderer"), "Office view should use a WebGL renderer");
  assert(officeSceneSource.includes("preserveDrawingBuffer: true"), "Office verifier screenshots should capture rendered WebGL pixels");
  assert(officeSceneSource.includes("buildOfficeFloor"), "Office view should build a 3D office floor");
  assert(officeSceneSource.includes("buildCubicle"), "Office view should render one 3D cubicle per agent");
  assert(officeSceneSource.includes("buildFocusedOffice"), "Office view should render a close-up 3D cubicle view");
  assert(officeSceneSource.includes("Raycaster"), "Office view should use 3D raycasting for cubicle selection");
  assert(officeSceneSource.includes("requestAnimationFrame"), "Office view should animate 3D scene details");
