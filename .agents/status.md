...
- Compact one-screen browser layout with collapsible Settings, scrollable Sources, one-row desktop controls, denser rows/actions, and dominant scrollable agent task list.
- Smoke test harness.
